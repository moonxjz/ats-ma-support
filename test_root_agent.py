...
from root_agent import (BusinessAction, RoutingReason, RoutingResult, RoutingStatus,
...
class RootRoutingTests(unittest.TestCase):
    ...
    def test_routing_never_calls_llm_agents_controller_or_store(self):
        targets = ["classifier.chat", "order_creation_extraction.chat",
                   "order_creation_confirmation.chat", "root_agent.process_order_creation_message",
                   "order_creation_controller.execute_order_creation_workflow",
                   "order_creation_controller.apply_order_creation_reentry",
                   "order_creation_order_store.create_order"]
    ...
    def test_import_has_no_demo_output_or_calls(self):
        with patch("builtins.print") as output, patch("classifier.chat") as llm:
