...
class OrderInformationExtractionTests(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher = patch("workflow.order.order_creation_extraction.chat")
    ...
    def test_inputs_unchanged_on_success_and_failure_no_merge_or_execution(self):
        ...
        with patch("workflow.order.order_creation_updates.apply_extracted_order_information") as merge, \
             patch("workflow.order.order_creation_controller.execute_order_creation_workflow") as execute:
