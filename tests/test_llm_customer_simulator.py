...
from tests.test_public_observation import configuration_text, final_text
...
class SimulatorTests(unittest.TestCase):
    ...
    def test_final_all_customer_fields_mismatch(self):
        from tests.test_public_observation import final_snapshot
        from workflow.confirmation_presentation import render_provisional_order
        text = configuration_text(self.customers[0]) + '\n\nPlease confirm the configuration.'
    ...
    def test_preserved_pilot_001_customer_approval(self):
        from tests.test_public_observation import PILOT_001_RESPONSE
