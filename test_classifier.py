...
from classifier import ClassifierResult, MessageCategory, classify_message
from order_creation_extraction import ConversationMessage
from order_creation_state import OrderCreationState, OrderCreationStage, OrderWorkflowStatus
...
class ClassifierBoundaryTests(unittest.TestCase):
    def setUp(self):
        self.patcher = patch("classifier.chat")
